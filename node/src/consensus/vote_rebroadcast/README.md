...
![rebroadcast diagram](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://raw.github.com/burst-node/burst-node/develop/node/src/vote_consensus/rebroadcast/doc/rebroadcast.puml)
