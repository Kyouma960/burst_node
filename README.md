...
[![Unit Tests](https://github.com/simpago/burst-node/actions/workflows/unit_tests.yml/badge.svg)](https://github.com/simpago/burst-node/actions/workflows/unit_tests.yml)
[![codecov](https://codecov.io/gh/burst-node/burst-node/graph/badge.svg?token=LIATNV5NBP)](https://codecov.io/gh/burst-node/burst-node)
...
using Burst. Let us know by [filing an issue](https://github.com/simpago/burst-node/issues), or joining us on [Discord](https://discord.gg/kBwvAyxEWE).

# The codebase

Have a look at the [AI generated documentation of the codebase](https://deepwiki.com/burst-node/burst-node).
...
![crate diagram](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://raw.github.com/burst-node/burst-node/develop/doc/crates.puml)
